(function () {
  ...
  function buildInstagramFabLink(href) {
    ...
    a.href = href;
    a.className = "instagram-fab-link";
    a.setAttribute("rel", "me noopener noreferrer");
    a.target = "_blank";
    a.setAttribute("aria-label", "Prime Music Institute on Instagram");
    ...
    svg.classList.add("instagram-fab-icon");
  ...
  function applyPmiSite() {
    ...
    var fab = document.getElementById("pmi-instagram-fab");
    if (fab) {
      fab.innerHTML = "";
      fab.setAttribute("hidden", "");
      if (S.social && S.social.instagram) {
        var igFabHref = String(S.social.instagram).trim();
        if (igFabHref && /^https:\/\//i.test(igFabHref)) {
          fab.appendChild(buildInstagramFabLink(igFabHref));
